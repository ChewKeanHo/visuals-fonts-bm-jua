# Baemin Jua (`BM JUA`) Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Baemin Jua is a Korean (ID: `KO`) handwriting font designed by
[Woowa Brothers Corporation](http://www.woowahan.com). It is based on the
handpainted variety of signboards also once commonly seen on Korean storefronts.
As is the hallmark of such freehand brushwork, the strokes of Jua are
non-uniform in thickness, with rounded edges, and evoke a warm, homey nostalgia
for bygone days.

This font is ideal for store display and natural body text presentation
...
```
Title: Baemin Jua (BM JUA) Font
Creators: Woowa Brothers Corporation
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-bm-jua
UUID: 7D658E3D-23C1-4790-BAAD-7486b5FF46FA
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-bm-jua
```
